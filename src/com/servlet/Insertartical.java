...
public class Insertartical extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Insertartical() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		artical.setArtical_id(UUID.randomUUID().toString());
		sqlHelper sql = new sqlHelper();
		boolean judge = sql.insertartical(artical);
		sql.destroy();
		...
		if(judge==false){			
			...
			out.println("  <HEAD><TITLE>A Servlet</TITLE></HEAD>");
			out.println("  <BODY>");
			out.println("插入失败");	out.println("<a href='addartical.jsp'>返回重新输入</a>");
			out.println("  </BODY>");
			out.println("</HTML>");
