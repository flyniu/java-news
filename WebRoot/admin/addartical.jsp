...
<hr>
    ...
    <form action="admin/Insertartical" method="post" name="frm">
    <table>
    	<tr>
    	<td> 新闻名称：</td>
    	<td> <input class="radius"  type="text" id="artical_name" name="artical_name" autocomplete="off" maxlength=50></input></td>
    	<td id="err_id"></td>
    	</tr>
    	...
    	<tr>
    	<td> 发布日期：</td>
    	<td> <input type="text"  id="artical_date" name="artical_date" onclick="WdatePicker()"></input></td>
    	<td id="err_name"></td>
    	</tr>
    	<tr>
    	<td valign="top"> 新闻正文：</td>
    	<td> <textarea name="content1" style="width:900px;height:300px;"></textarea></td>
    	<td id="err_name"></td>
    	</tr>
    	<tr>
    	<td>
