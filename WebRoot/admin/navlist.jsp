...
<html>
  ...
  <div class="content">
  <div class="title">
   <h2 align="center">新闻列表管理</h2>
  <hr>
  </div>
  
 <table class="tab" cellspacing="0" align="center">
 <tr><td>选择</td><td class="text-center">序号</td><td>分类名称</td><td>排序权重</td>
  <%
			ActionBean action = new ActionBean();
			out.println(action.queryNav());
  %>
 </tr>
 <tr><td colspan="4" style="border-bottom:0"><a class="btn" href="admin/addnav.jsp">
 	添加类别
 </a>
 ...
 <script type="text/javascript">
 	...
 	var obj=null;
 		...
 		if(confirm("确定删除？")){
 			location="del.jsp?nav_name="+obj.value;
 			}
 		}
 	}
 	function update(){
 		...
 		if(obj==null){
 			...
 			location="editnav.jsp?nav_name="+obj.value;
 		}
 	}
