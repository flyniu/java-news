...
nav = sql.querynavbyname(fonts.convertToutf8(name));
String nav_name = nav.getNav_name();
int nav_feight = nav.getNav_feight();
String nav_id = nav.getNav_id();
sql.destroy();
%>
...
<hr>
    ...
    <form action="admin/edit_nav" method="post">
    <table>
    	<tr>
    	<td> 新闻类别：</td>
    	<td> <input type="text" id="nav_name" name="nav_name" autocomplete="off" maxlength=50 value="<%= nav_name %>"></input></td>
    	<td id="err_id"></td>
    	</tr>
    	<tr>
    	<td> 排序权重：</td>
    	<td> <input  type="text" id="nav_feight" name="nav_feight" autocomplete="off" maxlength=10 value="<%=nav_feight %>"></input>
    	<input type="hidden" name="nav_id" value="<%=nav_id %>"></input>
    	</td>
    	<td id="err_name"></td>
    	</tr>
